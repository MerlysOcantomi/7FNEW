    ...
    <ClientPortalShell>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Solicitudes</h1>
            <p className="text-sm text-gray-500">
              Crea y gestiona solicitudes para tu equipo
            </p>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-gray-200 bg-white px-6 py-16 text-center">
            ...
            <p className="text-sm font-medium text-gray-900">
              {filter ? "No hay solicitudes con este filtro" : "No tienes solicitudes"}
            </p>
            <p className="mt-1 text-xs text-gray-500">
              Crea una nueva solicitud para comunicarte con tu equipo
            </p>
          </div>
        ) : (
                      ...
                      <div className="mt-2 flex items-center gap-3 text-xs text-gray-400 flex-wrap">
                        ...
                        {req.assets && req.assets.length > 0 && (
                          <span className="inline-flex items-center gap-1">
                            ...
                            {req.assets.length} archivo{req.assets.length > 1 ? "s" : ""}
                          </span>
                        )}
                      </div>
                    </div>
