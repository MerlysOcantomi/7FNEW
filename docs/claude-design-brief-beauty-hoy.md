...
10. **Panel de agentes/ayuda** — Fanny (operación), Freya (contenido), Fiona (marketing), Mr Forte (configuración/mejoras). Útil, no decorativo.
