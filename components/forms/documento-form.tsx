        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Name *" className="sm:col-span-2">
              <input type="text" value={nombre} onChange={(e) => setNombre(e.target.value)} placeholder="File name" className="input-field" autoFocus />
            </Field>
            ...
            <Field label="Size (bytes)">
              <input type="number" value={tamano} onChange={(e) => setTamano(e.target.value)} placeholder="e.g. 1048576" min="0" className="input-field" />
            </Field>
            <Field label="Client">
