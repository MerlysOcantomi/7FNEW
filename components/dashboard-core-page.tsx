...
/**
 * 7F Core "Business Overview" — the generic `/` dashboard, extracted verbatim
 * from `app/page.tsx` so the route can dispatch by vertical (Beauty renders
 * "Mi salón"; every other workspace keeps this page byte-for-byte). Mirrors
 * `components/content-core-page.tsx`.
 */
